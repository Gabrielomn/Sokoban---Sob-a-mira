...
{	
    ...
    BITMAP *CAIXA, *PAREDE, *FUNDO, *PERS0,*PERS1,*PERS2,*PERS3 , *DEST, *FIM, *MENU, *FASE, *GANHOU, *INFO, *CAIXA_CINZA,*S, *N,*N1,*N2,*N3,*N4 ;
	MIDI *MUS, *MEN;
    ...
    FIM=load_bitmap("Ganhou1.bmp", NULL);
    GANHOU=load_bitmap("Ganhoutudo.bmp", NULL);
    MENU=load_bitmap("Menu1.bmp", NULL);
    FASE=load_bitmap("Fases1.bmp", NULL);
    INFO = load_bitmap("INFO.bmp", NULL);
    
    S=load_bitmap("start.bmp",NULL);
    N=load_bitmap("nivel.bmp",NULL);
    N1=load_bitmap("nivel1.bmp",NULL);
    N2=load_bitmap("nivel2.bmp",NULL);
    N3=load_bitmap("nivel3.bmp",NULL);
    N4=load_bitmap("nivel4.bmp",NULL);
    ...
    while(!exit_program && !key[KEY_ESC])
    {
        ...
        while(!exit_program && !key[KEY_ESC]) 
        {
			...
			if(key[KEY_I]||((mouse_x > 139)&&(mouse_x < 378)&&(mouse_y > 363)&&(mouse_y < 406)))
            	draw_sprite(screen,S, 137,360);
			
        
            if(key[KEY_I]||((mouse_x > 139)&&(mouse_x < 378)&&(mouse_y > 363)&&(mouse_y < 406) &&(mouse_b)&& (1)))
			...
			if(key[KEY_S]||((mouse_x > 139)&&(mouse_x < 378)&&(mouse_y > 421)&&(mouse_y < 463)))
				draw_sprite(screen,N,135,412);  
				     
            if(key[KEY_S]||((mouse_x > 139)&&(mouse_x < 378)&&(mouse_y > 421)&&(mouse_y < 463) &&(mouse_b)&& (1)))  
                while(!exit_program && !key[KEY_ESC])
                {
                    rest(150);
					...
					if(key[KEY_1]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 187)&&(mouse_y < 228))) // efeito ao passar o mouse
 	                    draw_sprite(screen,N1,138,179);  
					  
					if(key[KEY_1]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 187)&&(mouse_y < 228) &&(mouse_b)&& (1)))
                    {  					                
						teste = 1;
                    ...
                    if(key[KEY_2]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 266)&&(mouse_y < 310)))
                    	draw_sprite(screen,N2,138,258);
                    
                    if(key[KEY_2]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 266)&&(mouse_y < 310) &&(mouse_b)&& (1)))
                    {
                        teste = 1;
                        segunda.tabuleiroinit();
                        fase(segunda, CAIXA, PAREDE, FUNDO, PERS0, PERS1, PERS2, PERS3, DEST, FIM,MUS, INFO,CAIXA_CINZA);
                    ...
                    if(key[KEY_3]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 343)&&(mouse_y < 387) ))
                    	draw_sprite(screen,N3,137,336);
                    
                    if(key[KEY_3]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 343)&&(mouse_y < 387) &&(mouse_b)&& (1)))
                    {
                        teste = 1;
                        terceira.tabuleiroinit();
                        fase(terceira, CAIXA, PAREDE, FUNDO, PERS0, PERS1, PERS2, PERS3, DEST, FIM,MUS, INFO,CAIXA_CINZA);
                    ...
                    if(key[KEY_4]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 420)&&(mouse_y < 463)))
                    	draw_sprite(screen,N4,137,411);
                    
                    if(key[KEY_4]||((mouse_x > 144)&&(mouse_x < 380)&&(mouse_y > 420)&&(mouse_y < 463) &&(mouse_b)&& (1)))
                    {   
                        teste = 1;
                        quarta.tabuleiroinit();
                        fase(quarta, CAIXA, PAREDE, FUNDO, PERS0, PERS1, PERS2, PERS3, DEST, FIM,MUS, INFO,CAIXA_CINZA);
